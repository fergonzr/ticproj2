...
**Descripción:**
Yo como paciente en situación de emergencia, necesito reportar una alerta de emergencia con un solo toque desde mi dispositivo móvil, para solicitar ayuda inmediata sin tener que describir verbalmente mis condiciones médicas en momentos de estrés o incapacidad física.

**Criterios de Aceptación:**
1. El botón de emergencia debe ser visible y accesible desde la pantalla principal de la aplicación
2. La activación debe requerir mínimo 3 segundos para confirmar y evitar activaciones accidentales
3. Debe existir confirmación visual, sonora y háptica de que la alerta fue enviada exitosamente
...
**Descripción:**
Yo como paciente accidentado, necesito que mi ubicación sea capturada automáticamente al activar la alerta, para evitar tener que describir verbalmente dónde me encuentro cuando estoy desorientado, herido o en un lugar desconocido.

**Criterios de Aceptación:**
1. La geolocalización debe capturarse automáticamente sin requerir acción adicional del usuario
2. La localización debe de tener una precisión de un radio de 50 metros como máximo.
3. Debe funcionar con la aplicación en primer plano durante la activación de la emergencia.
4. Debe mostrar al usuario la ubicación detectada en notación de direcciones para confirmación visual.
...
**Descripción:**
Yo como paciente o testigo en el lugar del accidente, necesito recibir instrucciones claras de primeros auxilios junto con mensajes de tranquilidad y acompañamiento mientras espero la ambulancia, para estabilizar mi condición o la de otros y reducir la ansiedad e incertidumbre durante la espera.
...
**Descripción:**
Yo como paciente esperando ayuda, necesito recibir actualizaciones sobre el estado de la ambulancia asignada, paraa reducir mi ansiedad e incertidumbre sabiendo cuánto falta para que llegue la ayuda y quién viene en camino.
...
**Descripción:**
Yo como usuario de la aplicación, necesito registrar información médica mía (alergias, condiciones crónicas, medicamentos), o de personas cercanas a mí, para que el personal de emergencia tenga acceso inmediato a datos críticos que puedan salvar mi vida si estoy inconsciente.
...
**Descripción:**
Yo como paciente siendo trasladado, necesito saber a qué hospital me están llevando y por qué fue seleccionado, para de entender el proceso, reducir mi ansiedad y poder informar a mis familiares sobre mi paradero.
...
**Descripción:**
Yo como paciente atendido, necesito recibir confirmación de que mi caso fue cerrado correctamente en el sistema, para tener tranquilidad de que mi atención no quedó abierta.

# Taken and modified from https://pyproject-nix.github.io/pyproject.nix/use-cases/pyproject.html
{
  ...
  outputs =
    ...
    let
      ...
      project-dev =
        let
          parsed-pyproject = pkgs.lib.importTOML ./pyproject.toml;
        in
        pyproject-nix.lib.project.loadPyproject {
          # Append development dependencies as well
          pyproject = parsed-pyproject // {
            project.dependencies =
              parsed-pyproject.project.dependencies ++ parsed-pyproject.dependency-groups.dev or [];
          };
        };
      system = "x86_64-linux";
    ...
    in
    {
      ...
      devShells.${system}.default =
        let
          ...
          arg = project-dev.renderers.withPackages { inherit python; };
